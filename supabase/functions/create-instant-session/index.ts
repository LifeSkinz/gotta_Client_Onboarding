...
serve(async (req) => {
  ...
  try {
    ...
    // NOTE: Video room is NOT created here - it's created when coach accepts via accept-session
    ...
    console.log('Session created (pending coach acceptance):', session.id);
